...
public class MyBot : IChessBot
{
    ...
    private decimal[] _maps =
    {

    };

    private int[] _setupMaps =
    {
        0,   0,   0,   0,   0,   0,  0,   0,
    ...
    IChessBot otherBot = new BotB1C();

    public Move Think(Board board, Timer timer)
    {
        return otherBot.Think(board, timer);
        ...
        //Calculate time
        _timeThisTurn = Math.Min(timer.MillisecondsRemaining / 15, (0.5f + (0.1f * Math.Min(board.PlyCount, 15))) * 1000);
        ...
        //Console.WriteLine("BotB1C finished at depth: " + searchDepth + " with searches: " + _searches + " and quiescnceSearhces: " + _quiescenceSearches);
        return bestMove;
    }
...
//Ideas:
//Right to castle
//Pawn structure (past pawns, isolated pawns)
//Strong moves